...
var tests = [
	...
	[ "exists", [ function( i ) { return i === 3; } ], true],
	[ "exists", [ function( i ) { return i === 8; } ], false],

	[ "isTrueForAll", [ function( i ) { return i !== 8; } ], true],
	[ "isTrueForAll", [ function( i ) { return i === 8; } ], false],

	[ "first", [], arr[0] ],

	[ "find", [ function( i ) { return i === 3; }, true ], 3 ],
	[ "find", [ function( i ) { return i === 8; }, 'something' ], 'something' ],

	[ "filter", [ function( i ) { return i <= 4; } ], ['length', 4] ],

	["indexOf", [3], 2],
	["indexOf", [8], -1],

	["select", [function(i) {return i*10;}], ['0', 10]],
	["map", [function(i) {return { key: i, value: i * 10 }; }], ['7', 70] ],

	["insertAt", [10, 3], function() { return arr[3] === 10; } ]
];
