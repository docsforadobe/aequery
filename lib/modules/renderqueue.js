...
aeq.renderqueue = {
	...
	getOMSettings: function(outputModule) {
		return outputModule.getSettings(GetSettingsFormat.STRING)
	},

	ensureRenderPathExists: function(outputModule) {
		var outputPath = aeq.renderqueue.getOMSettings(outputModule)["Full Flat Path"];
