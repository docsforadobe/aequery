aeq.ui = (function (my) {
	...
	my.Container.prototype = {
		...
		bounds: function() {
			var newValue = arguments.length === 4 ? Array.apply(null, arguments) : arguments[0];
			this.obj.bounds = newValue;
		},

		characters: function( newValue ) {
			if ( newValue !== undefined ) {
				return this.obj.characters;
			}
			this.obj.characters = newValue;
		},

		enabled: function( trueFalse ) {
			if ( trueFalse !== undefined ) {
				return this.obj.enabled;
			}
			this.obj.enabled = trueFalse;
		},

		helpTip: function(helpTipString) {
			if ( helpTipString !== undefined ) {
				return this.obj.helpTip;
			}
		...
		location: function(newValue) {
			...
			this.obj.location = newValue;
		},

		margins: function(newValue) {
			if ( newValue !== undefined ) {
				return this.obj.margins;
			}
			newValue = arguments.length === 4 ? Array.apply(null, arguments) : arguments[0];
			this.obj.margins = newValue;
		},

		maximumSize: function(newValue) {
			if ( newValue !== undefined ) {
				return this.obj.maximumSize;
			}
			newValue = arguments.length === 2 ? Array.apply(null, arguments) : arguments[0];
			this.obj.maximumSize = newValue;
		},

		minimumSize: function(newValue) {
			if ( newValue !== undefined ) {
				return this.obj.minimumSize;
			}
			newValue = arguments.length === 2 ? Array.apply(null, arguments) : arguments[0];
			this.obj.minimumSize = newValue;
		},

		orientation: function(orientation) {
			if ( orientation !== undefined ) {
				return this.obj.orientation;
			}
			this.obj.orientation = orientation;
		},

		preferredSize: function(newValue) {
			if ( newValue !== undefined ) {
				return this.obj.preferredSize;
			}
			newValue = arguments.length === 2 ? Array.apply(null, arguments) : arguments[0];
			this.obj.preferredSize = newValue;
		},
		...
		size: function(newValue) {
			...
			newValue = arguments.length === 2 ? Array.apply(null, arguments) : arguments[0];
			this.obj.size = newValue;
		},

		spacing: function(newValue) {
			if ( newValue !== undefined ) {
				return this.obj.spacing;
			}
			this.obj.spacing = newValue;
		},
