...
aeq.extend({
	...
	* an empty array is returned.
	 ...
	 * @param  {boolean} options.groups set to true to include property groups. Default is false;
	 * @param  {boolean} options.props set to true to include properties. Default is true;
	 * @return {aeq.arrayEx} Array of Property objects
	 */
